...
i would like you to come up with plan for:
- building a streamlit app that display the network edges and the plots generated by draw_lineage_plot
- the streamlit app has to be build from scratch and corresponding files should go in the folder streamlit_app.
- i want the streamlit app to have three pages: a welcome page, a page with a tabular representation of the network edges using the streamlit-aggrid package and the third page for displaying the graphviz plot
- the page with the plot should only display the plot once filters on the network have been set. functions related to 
